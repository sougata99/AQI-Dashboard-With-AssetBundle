...
The 'air_quality_index_bundle' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/air_quality_index_bundle/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] air_quality_index_bundle_etl` to your workspace.
